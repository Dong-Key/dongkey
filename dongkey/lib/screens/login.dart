          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                ...
                Center(
                    child: Image(
                  image: AssetImage('assets/aco.png'),
                  width: 200.0,
                  height: 250.0,
                )),
                Form(
                    child: Theme(
                        data: ThemeData(
                            primaryColor:
                                const Color.fromARGB(255, 255, 177, 0),
                            inputDecorationTheme: InputDecorationTheme(
                                labelStyle: TextStyle(
                                    color: Color.fromRGBO(255, 255, 194, 82),
                                    fontSize: 15.0))),
                        child: Container(
                                ...
                                child: ElevatedButton(
                                  style: ElevatedButton.styleFrom(
                                      primary: const Color.fromARGB(
                                          ...
                                          255,
                                          177,
                                          0)), // background onPrimary: Colors.white
                                  onPressed: () {
                                    if (controller1.text == '' &&
                                        controller2.text == '') {
                                      Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (BuildContext context) =>
                                                  MainPage()));
                                    } else if (controller1.text == 'minseo' &&
